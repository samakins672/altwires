<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="navbar-brand-wrapper d-flex justify-content-center">
    <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
      <a class="navbar-brand brand-logo" href="#"><img src="../images/afm-attendance-logo-white.png" alt="AFM attendance logo" /></a>
      <a class="navbar-brand brand-logo-mini" href="#"><img src="../images/afm-attendance-logo-circle.png" alt="AFM rounded logo" /></a>
